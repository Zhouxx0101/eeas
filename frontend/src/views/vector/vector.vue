<template>
  <div>
           ...
           <bm-control anchor="BMAP_ANCHOR_TOP_RIGHT">
              <el-card class="box-card" shadow="always">
                <div>
                  ...
                  <span style="color:black">此图展示的是各场所特征向量在特征空间的分布情况，涉及的特征包括：
                    <br>1. 场所类型
                    <br>2. 是否存在患者经过历史
                    <br>3. 当前是否存在患者
                    <br>4. 户数
      ...
      // import {imgUrl} from '@/assets/feature_vec/feature_vec_2021-12-15.png'
      ...
      export default {
        ...
        data() {
          return {
              // 地址信息
              imgUrl:require("./feature_vec/feature_vec_2022-01-08.png"),
              // imgUrl:require("@/assets/feature_vec/feature_vec_2021-12-15.png"),
              address: null,
              // center通过经纬度或城市名均可?
              center: { lng: 0, lat: 0 },
              // center: "北京",
        ...
        methods: {
         ...
         setTimer(){
          ...
          this.timer = setInterval(() => {
            ...
            this.curButton = this.curButton++ > ($("button").length-1) ? 0 : this.curButton;
    ...
    removeActive6 ($event) {
       ...
       async created() {
          ...
          async refresh(date) {
            ...
            this.value=""
            this.data=[]
            // let img="./feature_vec/feature_vec_"+date+".png";
            // console.log(img);
            // this.imgUrl=require(img);
            this.imgUrl=require("./feature_vec/feature_vec_"+date+".png");
            // imgUrl:require("./feature_vec/feature_vec_2022-01-08.png"),
