  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="数据源" prop="dataSource">
        <el-select v-model="queryParams.dataSource" placeholder="请选择数据源" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="taskList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="时间窗口" align="center" prop="timeInterval" />
      <el-table-column label="地点" align="center" prop="place" />
      <el-table-column label="数据源" align="center" prop="dataSource">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.eeas_task" :value="scope.row.dataSource"/>
        </template>
      </el-table-column>
