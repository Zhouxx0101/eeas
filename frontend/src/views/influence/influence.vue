     ...
     async handler({ BMap, map }) {
      ...
      this.getTopXXPlaces(value);
        ...
        async getHeatmapDataOfCertainPlace(place) {
          await getHeatmapDataOfCertainPlace(this.curDate,this.task.taskID,place,"4").then(response => {
        ...
        async getTopXXPlaces(place) {
          await getTopXXPlaces(this.curDate,this.task.taskID,place,"4").then(response => {
