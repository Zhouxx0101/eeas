...
<script>
import { listEvent, getEvent, delEvent, addEvent, updateEvent } from "@/api/data/event";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('data/event/export', {
        ...this.queryParams
